...
model = SupervisedModel(arch='AttentionUnet', criterion='MonaiDiceFocalLoss', mode='infer')
model_folder_name = model.get_name()

print('TESTING INFERENCE')
test_dataloader = DataLoader(test_dataset, batch_size=8, num_workers=8, shuffle=False)
